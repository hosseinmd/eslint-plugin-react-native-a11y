...
import shouldUseNativeProperties from './rules/should-use-native-properties';
...
const basicRules = {
  ...
  'react-native-a11y/should-use-native-properties': 'error',
};
...
export const rules = {
  ...
  'should-use-native-properties': shouldUseNativeProperties,
};
